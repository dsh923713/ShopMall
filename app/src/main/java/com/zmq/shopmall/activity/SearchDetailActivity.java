...
public class SearchDetailActivity extends BaseActivity {
    ...
    private List<SearchDetailBean> searchDetailBeen; //搜索列表模拟数据
    ...
    private TextView tv_synthesize_sort;
    private TextView tv_new_goods;
    private TextView tv_recommend_priority;
    ...
    protected void initView() {
        ...
        rvSearch.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (l.findFirstCompletelyVisibleItemPosition() > 1) {
                    fabUp.show();
                } else {
                    fabUp.hide();
                }
